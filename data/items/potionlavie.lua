-- Lua script of item potionlavie.
...
item:set_savegame_variable("possession_potionlavie")
item:set_amount_savegame_variable("amount_potionlavie")
...
item:set_finished()
      ...
      game:start_dialog("item.potionlavie.non")
      else
